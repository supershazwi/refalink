...
const Header2 = (props) => {
    ...
    const communicationFeatures = [
        {
            id: 1,
            name: 'Personal branded page',
            description:
                'A single avenue to identify you and your business to attract your ideal group of partners.',
            icon: EmojiHappyIcon,
        },
        {
            id: 2,
            name: 'Reputation via reviews',
            description:
                'By maintaining strong reviews, you can further increase your community of partners and thus expand your reach.',
            icon: StarIcon,
        },
        {
            id: 3,
            name: 'Track partner performance',
            description:
                'Have an overview of your partners and the customers they refer in.',
            icon: ChartBarIcon,
        },
    ]
                                ...
                                >
                                    <div className="flex items-center flex-1">
                                        <div className="flex items-center justify-between w-full md:w-auto">
                                            <a
                                                href="#"
                                                className="text-base font-extrabold text-2xl text-green-400"
                                                style={{ marginTop: "-4px" }}
                                            >
                                                Refalink
                                            </a>
                                            <div className="-mr-2 flex items-center md:hidden">
                                                <Popover.Button className="bg-green-700 rounded-md p-2 inline-flex items-center justify-center text-white hover:bg-gray-800 focus:outline-none focus:ring-2 focus-ring-inset focus:ring-white">
                                    ...
                                    <div className="hidden md:flex md:items-center md:space-x-6">
                                        ...
                                        <a
                                            href="#"
                                            className="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md text-white bg-green-500 hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-400 focus:ring-offset-gray-900"
                                        >
                                            Register
                                        </a>
                                    </div>
                                ...
                                >
                                    <div className="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
                                        <div className="px-5 pt-4 flex items-center justify-between">
                                            ...
                                            <div className="-mr-2">
                                                <Popover.Button className="bg-white rounded-md p-2 inline-flex items-center justify-center text-white hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-cyan-600">
                        ...
                        <div className="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl">
                            ...
                            <div className="relative">
                                <h2 className="text-center text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                                    Gamify your links to expand your reach
                                </h2>
                            ...
                            <div className="relative mt-12 sm:mt-16 lg:mt-24">
                                <div className="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
                                    <div className="lg:col-start-2">
                                        <h3 className="text-2xl font-extrabold text-gray-900 tracking-tight sm:text-3xl">Build a solid community of partners</h3>
                                        <p className="mt-3 text-lg text-gray-500">
                                            Nothing's more important than having a strong team of partners that help bring your business to the next level. Engage and reward them to maximise your team's performance.
                                        </p>
